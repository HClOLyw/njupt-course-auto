...
> 只需在设置页粘贴 **Access-Token** 并保存：**刷课与考试会自动使用默认的"安全教育课"**，无需手动填写课程 / 考试 ID。
...
| ✍ 自动考试 | 自动使用当前课程的【安全教育考试】，读取试卷、逐题作答并提交（内置题库已实测 100/100，合格线 90） |
| ⚙ 参数设置 | 只需填写 Access-Token；课程 / 考试 ID 留空即自动使用默认安全教育课程/考试 |
| ℹ 关于说明 | 功能原理与免责声明 |
